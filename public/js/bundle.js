        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)(res.data.status, 'Logged in successfully'); //when logged in, load the home page after 1 and a half seconds
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWF2ZXJpY2tkZXYyazIwIiwiYSI6ImNrY3JwMnM0ZzEycmoyeWxlenJxNjY3NjEifQ.F3fIKinWVLdWX1tE4VVe0g';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/maverickdev2k20/ckcrq23se13k01io3vslcnajp',
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)(res.data.status, "".concat(type.toUpperCase(), " updated successfully"));
            }
...
/* eslint-disable*/
var stripe = Stripe('pk_test_51HAA9eDQbK1EqspAreIUSe5K748NMl27b5axvUE7ADW2LK2t8bYh7h66k5eznXnB659OjmNN4yAbA3ppTMJIf7Zh00Uk3utaWm');
...
//DOM Elements
var mapBox = document.getElementById('map'); //checks for map element on front end webpage

var loginForm = document.querySelector('.form--login'); //checks for login/signup form element
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); //FormData is for creating "multipart/form-data" for Multer image upload
